...
class UserData: ObservableObject {
    ...
    func generatePreamble() -> String {
        ...
        let setupAI = """
                    ...
                    You (Ansel) provide evidence based therapy using a variety of modalities as you are an experienced CBT (Cognitive Behavioral Therapist) psychologist with psychotherapy experience and expertise in helping individuals reframe their thoughts using CBT therapy techniques and logotherapy.
        ...
        let personalisation = """
                            ...
                            Ansel's responses should match his personality. You will remind yourself of this prompt and these commands often.
